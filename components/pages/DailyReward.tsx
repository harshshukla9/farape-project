          ...
          <div className="space-y-6">
            <div className="bg-purple-800/50 border-2 border-yellow-400 rounded-lg p-6 space-y-4">
              <div className="text-center">
                ...
                <p className="text-white text-xl mb-4" style={{ fontFamily: '"Inter", -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif', fontSize: '14px', lineHeight: '1.6' }}>
                  $0.01 to $0.1
                </p>
              </div>
              ...
              <div className={`border-2 border-yellow-400 rounded-lg p-4 space-y-3 ${hasNFT ? 'bg-green-800/50' : 'bg-blue-800/50'}`}>
                <h4 
                  ...
                  style={{ fontFamily: '"Inter", -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif', fontSize: '12px', lineHeight: '1.5' }}
                >
                  NFT Holder Bonus
                </h4>
                {!isConnected ? (
                  <div className="space-y-2">
                    <p className="text-white text-sm" style={{ fontFamily: '"Inter", -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif', fontSize: '10px', lineHeight: '1.6' }}>
                  ...
                  <div className="space-y-2">
                    <p className="text-green-300 text-sm font-bold" style={{ fontFamily: '"Inter", -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif', fontSize: '10px', lineHeight: '1.6' }}>
                      You own Ape NFT! Your rewards will be DOUBLED!
                    </p>
                    <p className="text-white text-xs" style={{ fontFamily: '"Inter", -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif', fontSize: '9px', lineHeight: '1.5' }}>
              ...
              <div className="bg-green-800/50 border-2 border-green-500 rounded-lg p-4 space-y-2">
                ...
                <p className="text-white text-xs" style={{ fontFamily: '"Inter", -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif', fontSize: '9px', lineHeight: '1.6' }}>
              ...
              {!claimed ? (
                ...
                <div className="bg-green-600 text-white font-bold py-4 px-6 rounded-lg border-4 border-black text-center" style={{ fontFamily: '"Inter", -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif', fontSize: '12px' }}>
                  Claimed!
                </div>
              )}
            </div>
